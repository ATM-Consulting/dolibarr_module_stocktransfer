...
// Product
	...
	if ($action != 'presend')
	{
		...
		$somethingshown = $formactions->showactions($object, $object->element.'@stocktransfer', (is_object($object->thirdparty) ? $object->thirdparty->id : 0), 1, '', $MAXEVENT, '', $morehtmlright);
