...
class StockTransfer extends CommonObject
{
	...
	public $fields=array(
		...
		'fk_project' => array('type'=>'integer:Project:projet/class/project.class.php:1', 'label'=>'Project', 'enabled'=>'$conf->projet->enabled', 'position'=>32, 'notnull'=>-1, 'visible'=>-1, 'index'=>1,),
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$url = dol_buildpath('/stocktransfer/stocktransfer_card.php', 1).'?id='.$this->id;
