...
/**
 * \file    test/phpunit/StockTransferFunctionalTest.php
...
/**
 * Class StockTransferFunctionalTest
 *
 ...
 *
 * @package Teststocktransfer
 */
class StockTransferFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modStockTransfer')->click();
		} else {
			// Disable the module
			$this->byHref('modStockTransfer')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/stocktransfer/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('stocktransfer/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/stocktransfer/admin/about.php');
		$this->authenticate();
		return $this->assertContains('stocktransfer/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('stocktransferwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modStockTransfer_StockTransferTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modStockTransfer_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
