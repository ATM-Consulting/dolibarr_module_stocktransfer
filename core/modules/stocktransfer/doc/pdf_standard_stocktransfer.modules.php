...
/**
 *  \file       core/modules/stocktransfer/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_stocktransfer
 */
class pdf_standard_stocktransfer extends ModelePDFStockTransfer
{
    /**
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
	    ...
	    if ($conf->stocktransfer->dir_output.'/stocktransfer')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->stocktransfer->dir_output.'/stocktransfer';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->stocktransfer->dir_output.'/stocktransfer/'.$objectref;
