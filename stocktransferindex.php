...
/**
 *	\file       stocktransfer/stocktransferindex.php
 *	\ingroup    stocktransfer
 *	\brief      Home page of stocktransfer top menu
 */
...
$langs->loadLangs(array("stocktransfer@stocktransfer"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->stocktransfer->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("StockTransferArea"));

print load_fiche_titre($langs->trans("StockTransferArea"), '', 'stocktransfer.png@stocktransfer');
...
// Draft MyObject
if (! empty($conf->stocktransfer->enabled) && $user->rights->stocktransfer->read)
{
	$langs->load("orders");
